...
public class AESUtil {
    ...
    //加密id
    public static String getEncryptUUid(String id) throws Exception {
    ...
    //解密id
    public static String getDecryptId(String uuid) throws Exception {
        String password = "123456";     //加解密的密码
        byte[] secretKey = getSecretKey(password);
        Key key = toKey(secretKey);
        byte[] decryptData = decrypt(Hex.decodeHex(uuid.toCharArray()), key);
